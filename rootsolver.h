 ...
 * @param[out] pi_error_code pointer to int to write error code in which function should write code in case of error
 *
 * @note Fills pd_answers with INFINITY if equation has infinite number of solutions and NAN if zero.
 */
void solve_square(const double d_a, const double d_b, const double d_c, double pd_answers[4], int* pi_error_code = NULL);
